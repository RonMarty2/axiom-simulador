...
function BalanzaEcuacion() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 620, display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <Hint>
        {restado === 0
          ? "x + 3 = 7. Prueba a sacarle 3 a los dos platillos, y después a uno solo"
          : aLosDos
  ...
  return (
    <EscenaRica>
      ...
      <Cuidado>
        ...
        <span style={{ fontSize: 13 }}>
          Siempre sustituye tu x en la ecuación original y comprueba. 30 segundos que evitan errores grandes.
        </span>
      </Cuidado>
