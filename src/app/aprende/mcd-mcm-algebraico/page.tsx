...
function CancelarFactores() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 620, display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <Hint>{tachado ? "El (x + 3) que estaba arriba y abajo se fue" : "Toca para cancelar el factor común"}</Hint>
    </div>
  );
}
...
function CancelarTrampa() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 620 }}>
      ...
      <Hint>A la izquierda (x + 3) multiplica arriba y abajo: se cancela. A la derecha la x está sumando, y queda atrapada</Hint>
    </div>
  );
}
