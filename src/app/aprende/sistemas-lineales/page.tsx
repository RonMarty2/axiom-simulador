...
function SustitucionVisual() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 620, display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <Hint>
        {paso === 0 && "Toca: reemplaza la y de la ecuación 2 por su valor"}
        {paso === 1 && "Toca: ya queda una sola incógnita, resuélvela"}
        {paso === 2 && "Toca para volver al inicio"}
      </Hint>
    </div>
  );
}
...
function ReduccionVisual() {
  ...
  return (
    <div style={{ width: "100%", maxWidth: 620, display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <Hint>{sumado ? "Una sola incógnita: 2x = 12" : "Toca para sumar las dos ecuaciones"}</Hint>
    </div>
  );
}
    ...
    <div style={{ width: "100%", maxWidth: 620, display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <Hint>
        {cumple
          ...
          : "Moviendo el control siempre hay 25 billetes, pero el monto cambia: busca los 92 Bs"}
      </Hint>
    </div>
  );
}
...
function SignosReduccionVisual() {
  ...
  const bloques = [
    {
      cx: 128, signos: ["+ 2y", "+ 2y"], op: "RESTA", color: LIENZO.bad,
      nota: "mismo signo",
    },
    {
      cx: 352, signos: ["+ y", "− y"], op: "SUMA", color: LIENZO.ok,
      nota: "signo opuesto",
    },
  ];
  ...
  return (
    <EscenaRica>
      ...
      <Cuidado>
        ...
        <span style={{ fontSize: 13 }}>
          Sustituye TU SOLUCIÓN en LAS DOS ecuaciones. Si una no se cumple, hubo un error.
        </span>
      </Cuidado>
