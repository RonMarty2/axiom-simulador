...
const PLANES = [
  {
    ...
    contras: ["Sin modo predictivo", "Sin plan personalizado IA", "Sin banco de errores"],
    cta: "Empezar gratis",
  },
  {
    id: "pro",
    ...
    precio: 50,
    color: "#a855f7",
    descripcion: "Para preparación seria",
    badge: "MÁS POPULAR",
    features: [
      "Simulacros ilimitados",
      "Acceso a todas las facultades",
      "Los 5 modos sin IA (real, mixto, predictivo, por tema, mis errores)",
      "Banco de errores",
  ...
  },
  {
    ...
    precio: 100,
    color: "#fbbf24",
    descripcion: "Todo Pro + IA infinita",
    features: [
      "Todo lo del plan Pro",
      "IA infinita: preguntas únicas generadas en el momento",
      "Plan personalizado de estudio (IA)",
      "Explicación detallada de errores con IA",
      "Tutor 24/7 con Q&A",
      "Soporte prioritario",
    ],
