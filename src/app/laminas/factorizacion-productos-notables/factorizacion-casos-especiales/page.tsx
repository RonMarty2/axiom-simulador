      ...
      contenido: (
        <div>
          <p style={{ margin: "0 0 12px", fontSize: 14.5, lineHeight: 1.6 }}>
            Ya sabés factorizar <MathText>{"$x^2+bx+c$"}</MathText> buscando dos números. La aspa simple extiende esa idea a <MathText>{"$ax^2+bx+c$"}</MathText>, cuando el coeficiente de <MathText>{"$x^2$"}</MathText> no es 1.
          </p>
        ...
        <div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.accent}12`, border: `1.5px solid ${LIENZO.accent}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Buscá dos parejas de números cuyo producto dé <MathText>{"$a$"}</MathText> y <MathText>{"$c$"}</MathText></span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.ok}12`, border: `1.5px solid ${LIENZO.ok}44` }}>
              <span style={{ fontSize: 13, fontWeight: 700, minWidth: 22 }}>2.</span>
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Multiplicá en cruz y sumá: ese resultado tiene que dar <MathText>{"$b$"}</MathText></span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.warn}12`, border: `1.5px solid ${LIENZO.warn}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Si no da, probá otra pareja de factores hasta que cierre</span>
            </div>
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      contenido: (
        <div>
          ...
          <div style={{ background: LIENZO.bgSoft, borderRadius: 12, padding: "12px 14px" }}>
            <LineaEjemplo glosa="Identidad alternativa: (x-y)³+3xy(x-y), útil cuando ya tenés x-y y xy" eq={"$E = 4^3 + 3(3)(4)$"} />
