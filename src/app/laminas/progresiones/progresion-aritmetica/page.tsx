      ...
      contenido: (
        <div>
          <p style={{ margin: "0 0 12px", fontSize: 14.5, lineHeight: 1.6 }}>
            Ya sabés sumar un número fijo varias veces. Una progresión aritmética (PA) es justamente eso: cada término sale del anterior sumándole SIEMPRE la misma razón <MathText>{"$d$"}</MathText>.
          </p>
        ...
        <div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.accent}12`, border: `1.5px solid ${LIENZO.accent}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Identificá el primer término <MathText>{"$a_1$"}</MathText> y la razón <MathText>{"$d$"}</MathText></span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.warn}12`, border: `1.5px solid ${LIENZO.warn}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Aplicá <MathText>{"$a_n=a_1+(n-1)d$"}</MathText> para el término que buscás</span>
            </div>
          </div>
        </div>
      ),
