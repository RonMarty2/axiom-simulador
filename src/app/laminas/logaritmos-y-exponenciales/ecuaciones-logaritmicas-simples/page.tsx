      ...
      contenido: (
        <div>
          <p style={{ margin: "0 0 12px", fontSize: 14.5, lineHeight: 1.6 }}>
            Ya sabés la definición del logaritmo. Cuando queda UN solo logaritmo igualado a un número, aplicarla directo despeja la incógnita.
          </p>
        ...
        <div>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.ok}12`, border: `1.5px solid ${LIENZO.ok}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Aplicá la definición para quitar el logaritmo</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 10, background: `${LIENZO.warn}12`, border: `1.5px solid ${LIENZO.warn}44` }}>
              ...
              <span style={{ fontSize: 12.5, color: LIENZO.fgDim }}>Resolvé y VERIFICÁ que el argumento original quede positivo</span>
            </div>
          </div>
        </div>
      ),
